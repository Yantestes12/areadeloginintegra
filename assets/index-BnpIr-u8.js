...
var l = o((e) => {
  ...
  h = o((e) => {
    ...
    var k = me(null),
      ...
      _e = me(null);
    function ve(e, t) {
      switch ((O(ge, t), O(he, e), O(k, null), t.nodeType)) {
        case 9:
        case 11:
    ...
    function be(e) {
      (he.current === e && (D(k), D(he)), _e.current === e && (D(_e), (Qf._currentValue = de)));
    }
    var xe, Se;
    function Ce(e) {
      if (xe === void 0)
...
` +
    ...
    function $e(e, t, n) {
      ...
      return (
        s === 0
          ? ((s = r & ~a),
            s === 0 ? (o === 0 ? n || ((n = r & ~e), n !== 0 && (i = Qe(n))) : (i = Qe(o))) : (i = Qe(s)))
          : ((r = s & ~a),
            r === 0 ? ((o &= s), o === 0 ? n || ((n = s & ~e), n !== 0 && (i = Qe(n))) : (i = Qe(o))) : (i = Qe(r))),
        i === 0
          ? 0
    ...
    function qt(e, t, n, r, i, a, o, s) {
      ((e.name = ``),
        ...
        t == null ? (n == null ? r != null && e.removeAttribute(`value`) : Yt(e, o, zt(n))) : Yt(e, o, zt(t)),
    ...
    function pn(e) {
      ...
      if (t && (e = t.stateNode)) {
        ...
        a: switch (((e = t.stateNode), t.type)) {
          case `input`:
            if (
              (qt(e, n.value, n.defaultValue, n.defaultValue, n.checked, n.defaultChecked, n.type, n.name),
              (t = n.name),
              n.type === `radio` && t != null)
            ) {
    ...
    function ur(e, t) {
      if (cr)
        return e === `compositionend` || (!er && or(e, t)) ? ((e = Cn()), (Sn = xn = bn = null), (cr = !1), e) : null;
      switch (e) {
        case `paste`:
          return null;
        case `keypress`:
    ...
    function pr(e, t, n, r) {
      (dn ? (fn ? fn.push(r) : (fn = [r])) : (dn = r),
        (t = Ed(t, `onChange`)),
        0 < t.length && ((n = new kn(`onChange`, `change`, null, n, r)), e.push({ event: n, listeners: t })));
    }
    var mr = null,
      hr = null;
    function gr(e) {
    ...
    function Hr(e, t, n) {
      ...
      Vr ||
        ...
        (Br && jr(Br, r)) ||
          ...
          (r = Ed(zr, `onSelect`)),
          0 < r.length &&
            ((t = new kn(`onSelect`, `select`, null, t, n)), e.push({ event: t, listeners: r }), (t.target = Rr))));
    }
    function Ur(e, t) {
      var n = {};
    ...
    function bi(e, t, n, r, a, o) {
      ...
      if (((r = e), typeof e == `function`)) _i(e) && (s = 1);
        ...
        s = Uf(e, n, k.current) ? 26 : e === `html` || e === `head` || e === `body` ? 27 : 5;
      else
        a: switch (e) {
          case ie:
    ...
    function Ei(e, t) {
      if (typeof e == `object` && e) {
        var n = Ti.get(e);
        return n === void 0 ? ((t = { value: e, source: t, stack: De(t) }), Ti.set(e, t), t) : n;
      }
    ...
    function zi(e) {
      ...
      for (; e === Ni;)
        ((Ni = ji[--Mi]), (ji[Mi] = null), (Fi = ji[--Mi]), (ji[Mi] = null), (Pi = ji[--Mi]), (ji[Mi] = null));
    }
    function Bi(e, t) {
    ...
    function Gi(e) {
      throw (
        Zi(Ei(Error(i(418, 1 < arguments.length && arguments[1] !== void 0 && arguments[1] ? `text` : `HTML`, ``)), e)),
        Wi
      );
    }
    function Ki(e) {
    ...
    var da =
      ...
      N = { $$typeof: S, Consumer: null, Provider: null, _currentValue: null, _currentValue2: null, _threadCount: 0 };
    function ma() {
    ...
    function Ua(e) {
      ...
      function l(e, t, n, r) {
        ...
        return i === y
          ...
          : t !== null && (t.elementType === i || (typeof i == `object` && i && i.$$typeof === w && Pa(i) === t.type))
            ...
            case _:
              a: {
                for (var l = o.key; r !== null;) {
                  if (r.key === l) {
                    if (((l = o.type), l === y)) {
                      ...
                      r.elementType === l ||
                      (typeof l == `object` && l && l.$$typeof === w && Pa(l) === r.type)
                    ) {
                ...
                o.type === y
                  ...
                  : ((c = bi(o.type, o.key, o.props, null, e.mode, c)), Va(c, o), (c.return = e), (e = c));
              }
              return s(e);
            case v:
              a: {
    ...
    function to(e, t, n, r) {
      ...
      if (a !== null) {
        ...
        do {
          ...
          if (p ? (q & f) === f : (r & f) === f) {
            (f !== 0 && f === va && ($a = !0),
              u !== null && (u = u.next = { lane: 0, tag: s.tag, payload: s.payload, callback: null, next: null }));
            a: {
              var m = e,
                g = s;
              f = t;
    ...
    function Io(e) {
      ...
      return (
        ...
        (L === null ? t.memoizedState : L.next) === null &&
          ((t = t.alternate), (T.H = t === null || t.memoizedState === null ? Us : Ws)),
        e
      );
    }
    function Lo(e) {
    ...
    function Vo(e, t, n) {
      ...
      if (((o = e.baseState), a === null)) e.memoizedState = o;
        ...
        if ((l === null ? (s = o) : (l.next = c), !Ar(o, e.memoizedState) && ((B = !0), d && ((n = ya), n !== null))))
          throw n;
    ...
    function Uo(e, t, n) {
      ...
      if (
        ...
        if (((r.flags |= 2048), ls(9, { destroy: void 0 }, Go.bind(null, r, a, n, t), null), G === null))
          throw Error(i(349));
        o || vo & 127 || Wo(r, t, n);
      }
      return n;
    ...
    function Yo(e) {
      ...
      return (
        ...
        (t.queue = { pending: null, lanes: 0, dispatch: null, lastRenderedReducer: zo, lastRenderedState: e }),
        t
      );
    }
    function Xo(e, t, n, r) {
    ...
    function Zo(e, t, n, r, a) {
      ...
      if (((e = t.action), e !== null)) {
        ...
        (T.T === null ? (o.isTransition = !1) : n(!0),
          r(o),
          (n = t.pending),
          n === null ? ((o.next = t.pending = o), Qo(t, o)) : ((o.next = n.next), (t.pending = n.next = o)));
      }
    }
    function Qo(e, t) {
      var n = t.action,
    ...
    function es(e, t, n) {
      ((t.status = `fulfilled`),
        ...
        (e.state = n),
        (t = e.pending),
        t !== null && ((n = t.next), n === t ? (e.pending = null) : ((n = n.next), (t.next = n), Qo(e, n))));
    }
    function ts(e, t, n) {
      var r = e.pending;
    ...
    function is(e, t) {
      ...
      return (
        ...
        (r = { pending: null, lanes: 0, dispatch: null, lastRenderedReducer: rs, lastRenderedState: t }),
        (n.queue = r),
        (n = Is.bind(null, F, r)),
        (r.dispatch = n),
        (r = Yo(!1)),
    ...
    function os(e, t, n) {
      if (((t = Vo(e, t, rs)[0]), (e = Bo(zo)[0]), typeof t == `object` && t && typeof t.then == `function`))
        try {
          var r = Io(t);
        } catch (e) {
          throw e === Oa ? Aa : e;
      ...
      var i = t.queue,
        a = i.dispatch;
      return (
        n !== t.memoizedState && ((F.flags |= 2048), ls(9, { destroy: void 0 }, ss.bind(null, i, n), null)),
        [r, a, e]
      );
    }
    function ss(e, t) {
    ...
    function Es(e, t, n, r, i) {
      ...
      try {
        var c = i(),
          l = T.S;
        (l !== null && l(s, c),
          typeof c == `object` && c && typeof c.then == `function` ? Ls(e, t, Sa(c, r), pu(e)) : Ls(e, t, r, pu(e)));
      } catch (n) {
    ...
    function ks(e) {
      ...
      t = {
        ...
        baseState: de,
        baseQueue: null,
        queue: { pending: null, lanes: 0, dispatch: null, lastRenderedReducer: zo, lastRenderedState: de },
        next: null,
      };
      var n = {};
      return (
        (t.next = {
          ...
          baseState: n,
          baseQueue: null,
          queue: { pending: null, lanes: 0, dispatch: null, lastRenderedReducer: zo, lastRenderedState: n },
          next: null,
        }),
        (e.memoizedState = t),
        (e = e.alternate),
    ...
    function Rs(e, t, n, r) {
      if (
        ((r = { lane: 2, revertLane: dd(), gesture: null, action: r, hasEagerState: !1, eagerState: null, next: null }),
        zs(e))
      ) {
        ...
        switch (n.tag) {
          ...
          case 1:
            if (
              ...
              return ((n.flags |= 65536), (a &= -a), (n.lanes |= a), (a = rc(a)), ic(a, e, n, r), Qa(n, a), !1);
        }
        n = n.return;
      } while (n !== null);
      return !1;
    ...
    function cc(e, t, n, r, i) {
      ...
      return (
        ...
        (r = Do(e, t, n, o, a, i)),
        (s = jo()),
        e !== null && !B ? (Mo(e, t, i), Mc(e, t, i)) : (M && s && Ri(t), (t.flags |= 1), sc(e, t, r, i), t.child)
      );
    }
    ...
    function gc(e, t, n) {
      ...
      if (o !== null) {
        ...
        if ((po(t), a)) {
          ...
          if (((r = G), r !== null && ((s = ct(r, n)), s !== 0 && s !== o.retryLane)))
    ...
    function vc(e, t, n, r, i) {
      return (
        ...
        (r = jo()),
        e !== null && !B ? (Mo(e, t, i), Mc(e, t, i)) : (M && r && Ri(t), (t.flags |= 1), sc(e, t, n, i), t.child)
      );
    }
    function yc(e, t, n, r, i, a) {
      return (
        ...
        Oo(e),
        (r = jo()),
        e !== null && !B ? (Mo(e, t, a), Mc(e, t, a)) : (M && r && Ri(t), (t.flags |= 1), sc(e, t, n, a), t.child)
      );
    }
      ...
      if ((sa(t), t.stateNode === null)) {
        ...
        o !== d || f !== p || Ka || (e !== null && e.dependencies !== null && oa(e.dependencies))
          ? (typeof s == `function` && (Ks(t, n, s, r), (p = t.memoizedState)),
            (u = Ka || Js(t, n, u, r, f, p, c) || (e !== null && e.dependencies !== null && oa(e.dependencies)))
              ? (l ||
      ...
      return (
        ...
        a || r
          ? ((a = t.stateNode),
            ...
            (t.flags |= 1),
            e !== null && r ? ((t.child = Wa(t, e.child, null, i)), (t.child = Wa(t, null, n, i))) : sc(e, t, n, i),
    ...
    function Tc(e, t, n) {
      ...
      if (l !== null && ((c = l.dehydrated), c !== null)) {
        if (o)
          ...
          if (((s = G), s !== null && ((r = ct(s, n)), r !== 0 && r !== l.retryLane)))
      ...
      return a
        ? (ho(t),
          ...
          c === null
            ? (c = Cc(n))
            : ((a = c.cachePool),
              a === null ? (a = Da()) : ((l = N._currentValue), (a = a.parent === l ? a : { parent: l, pool: l })),
      ...
      switch (((t.lanes = 0), t.tag)) {
        ...
        case 3:
          a: {
            ...
            if (
              ((r = s.cache), ta(t, N, r), r !== o.cache && ia(t, [N], n, !0), eo(), (r = s.element), o.isDehydrated)
            ) {
              if (
              ...
              for (j = cf(e.firstChild), Vi = t, M = !0, Hi = null, Ui = !0, n = Ga(t, null, r, n), t.child = n; n;)
          ...
          return (
            e === null &&
              ...
              ((a = r = j) &&
                ...
                r === null ? (a = !1) : ((t.stateNode = r), (Vi = t), (j = cf(r.firstChild)), (Ui = !1), (a = !0))),
              a || Gi(t)),
            A(t),
            (a = t.type),
            (o = t.pendingProps),
    ...
    function Vc(e, t, n) {
      ...
      switch ((zi(t), t.tag)) {
        ...
        case 3:
          return (
            ...
            (e === null || e.child === null) &&
              (Ji(t)
                ? Ic(t)
                : e === null || (e.memoizedState.isDehydrated && !(t.flags & 256)) || ((t.flags |= 1024), Xi())),
            V(t),
            null
          );
        case 26:
        ...
        case 27:
          if ((be(t), (n = ge.current), (a = t.type), e !== null && t.stateNode != null))
            ...
            ((e = k.current), Ji(t) ? Ki(t, e) : ((e = ff(a, r, n)), (t.stateNode = e), Ic(t)));
          }
          return (V(t), null);
        case 5:
        ...
        case 13:
          if (
            ...
            if (((a = Ji(t)), r !== null && r.dehydrated !== null)) {
              ...
              ((a = Xi()), e !== null && e.memoizedState !== null && (e.memoizedState.hydrationErrors = a), (a = !0));
        ...
        case 4:
          return (ye(), e === null && Sd(t.stateNode.containerInfo), V(t), null);
        case 10:
        ...
        case 23:
          return (
            ...
            r ? n & 536870912 && !(t.flags & 128) && (V(t), t.subtreeFlags & 6 && (t.flags |= 8192)) : V(t),
            (n = t.updateQueue),
    ...
    function Hc(e, t) {
      switch ((zi(t), t.tag)) {
        ...
        case 3:
          return (na(N), ye(), (e = t.flags), e & 65536 && !(e & 128) ? ((t.flags = (e & -65537) | 128), t) : null);
        case 26:
        case 27:
        case 5:
          return (be(t), null);
    ...
    function yl(e, t) {
      ...
      switch (e.tag) {
        ...
        case 5:
          ...
          (r & 4 && e.stateNode != null && ((a = e.memoizedProps), Zc(e, a, n === null ? a : n.memoizedProps)),
            r & 1024 && (il = !0));
          break;
        case 6:
          if ((_l(t, e), bl(e), r & 4)) {
    ...
    function Bu() {
      if (X === 4 || X === 3) {
        ...
        if ((i === 0 && (iu = null), ut(n), (t = t.stateNode), Ue && typeof Ue.onCommitFiberRoot == `function`))
          try {
    ...
    function Ku(e, t, n) {
      ...
      (r !== null && r.delete(t),
        ...
        G === e &&
          (q & n) === n &&
          (Y === 4 || (Y === 3 && (q & 62914560) === q && 300 > Ne() - eu) ? !(W & 2) && Su(e, 0) : (Jl |= n),
          Xl === q && (Xl = 0)),
        rd(e));
    }
    function qu(e, t) {
          ...
          for (var n = !1, r = Zu; r !== null;) {
            if (!t) {
              if (e !== 0) {
                ...
                ((a = q),
                  (a = $e(r, r === G ? a : 0, r.cancelPendingCommit !== null || r.timeoutHandle !== -1)),
    ...
    function sd(e, t) {
      ...
      if (
        ...
        return (r !== null && r !== null && Ae(r), (e.callbackNode = null), (e.callbackPriority = 0));
      if (!(n & 3) || et(e, n)) {
    ...
    function cd(e, t) {
      ...
      var r = q;
      return (
        (r = $e(e, e === G ? r : 0, e.cancelPendingCommit !== null || e.timeoutHandle !== -1)),
        r === 0
          ? null
          : (gu(e, r, t), sd(e, Ne()), e.callbackNode != null && e.callbackNode === n ? cd.bind(null, e) : null)
      );
    }
    function ld(e, t) {
      if (Hu()) return null;
    ...
    function Ed(e, t) {
      for (var n = t + `Capture`, r = []; e !== null;) {
        ...
        if (
          ...
          (i !== 5 && i !== 26 && i !== 27) ||
            a === null ||
            ((i = gn(e, n)), i != null && r.unshift(Td(e, i, a)), (i = gn(e, t)), i != null && r.push(Td(e, i, a))),
          e.tag === 3)
        )
          return r;
        e = e.return;
...
`,
        ...
        ((i = `link[rel="` + e + `"][href="` + i + `"]`),
          ...
          hf.has(i) ||
            ...
            r.querySelector(i) === null &&
              ((t = r.createElement(`link`)), Pd(t, `link`, e), Dt(t), r.head.appendChild(t))));
      }
    }
    function Sf(e) {
      ...
      jp !== e &&
        ...
        t.unstable_scheduleCallback(t.unstable_NormalPriority, function () {
          ...
          for (var t = 0; t < e.length; t += 3) {
            ...
            var a = wt(n);
            a !== null &&
              (e.splice(t, 3), (t -= 3), Os(a, { pending: !0, data: i, method: n.method, action: r }, r, i));
          }
        }));
    }
    function Np(e) {
  ...
  w = (e, t) => {
    let n = (0, _.forwardRef)(({ className: n, ...r }, i) =>
      (0, _.createElement)(re, { ref: i, iconNode: t, className: y(`lucide-${b(ee(e))}`, `lucide-${e}`, n), ...r }),
    );
  ...
  E = () =>
    (0, T.jsxs)(`svg`, {
      ...
      className: `w-4 h-4`,
      children: [
        (0, T.jsx)(`rect`, { x: `2`, y: `2`, width: `20`, height: `20`, rx: `5`, ry: `5` }),
        (0, T.jsx)(`circle`, { cx: `12`, cy: `12`, r: `4` }),
        (0, T.jsx)(`circle`, { cx: `17.5`, cy: `6.5`, r: `0.5`, fill: `currentColor`, stroke: `none` }),
      ],
    }),
  de = `https://w.ibrase.com.br/webhook`,
  fe = (e) =>
    e
      .replace(/\D/g, ``)
      .replace(/(\d{3})(\d)/, `$1.$2`)
  ...
  D = () => {
    ...
    return (
      (0, _.useEffect)(() => {
        ...
        let n,
          r = () => {
            let e = t.clientWidth || window.innerWidth,
              n = t.clientHeight || window.innerHeight;
            (t.width !== e || t.height !== n) && ((t.width = e), (t.height = n));
          };
        (window.addEventListener(`resize`, r), r());
        let i = t.getContext(`webgl`) || t.getContext(`experimental-webgl`);
        if (!i) return;
        let a = (e, t) => {
        ...
        (i.attachShader(
          ...
          a(
            i.VERTEX_SHADER,
            `attribute vec2 a_position; varying vec2 v_uv; void main() { v_uv = a_position * 0.5 + 0.5; gl_Position = vec4(a_position, 0.0, 1.0); }`,
          ),
        ),
          i.attachShader(
            o,
            a(
              i.FRAGMENT_SHADER,
              `precision highp float; varying vec2 v_uv; uniform float u_time;
void main() {
  vec2 uv = v_uv;
  ...
  gl_FragColor = vec4(col, 1.0);
          ...
          i.linkProgram(o),
          i.useProgram(o));
        let s = i.createBuffer();
        (i.bindBuffer(i.ARRAY_BUFFER, s),
          i.bufferData(i.ARRAY_BUFFER, new Float32Array([-1, -1, 1, -1, -1, 1, 1, 1]), i.STATIC_DRAW));
        let c = i.getAttribLocation(o, `a_position`);
        (i.enableVertexAttribArray(c), i.vertexAttribPointer(c, 2, i.FLOAT, !1, 0, 0));
        let l = i.getUniformLocation(o, `u_time`),
          u = (e) => {
            (r(),
              i.viewport(0, 0, t.width, t.height),
              l && i.uniform1f(l, e * 0.001),
        ...
        return (
          u(0),
          () => {
            (window.removeEventListener(`resize`, r), cancelAnimationFrame(n));
          }
        );
      }, []),
      (0, T.jsx)(`div`, {
        className: `fixed top-0 left-0 w-[100vw] h-[100vh] -z-10 pointer-events-none opacity-80`,
        children: (0, T.jsx)(`canvas`, { ref: e, className: `block w-full h-full` }),
      })
    );
  },
  O = ({ children: e }) =>
    (0, T.jsx)(`label`, {
      className: `block text-xs font-bold text-gray-400 mb-2 ml-1 uppercase tracking-widest`,
      children: e,
    }),
  k = ({ ...e }) =>
    (0, T.jsx)(`input`, {
      ...e,
      className: `custom-input w-full rounded-xl py-3.5 px-4 text-white ${e.className || ``}`,
    }),
  he = ({ children: e, ...t }) =>
    (0, T.jsx)(`select`, {
      ...t,
      className: `custom-input w-full rounded-xl py-3.5 px-4 text-white appearance-none`,
      children: e,
    }),
  ge = ({ label: e, value: t, mono: n, highlight: r }) =>
    (0, T.jsxs)(`div`, {
      className: `flex flex-col sm:flex-row sm:items-center sm:justify-between py-1.5 border-b border-white/5 last:border-0 gap-1 sm:gap-4`,
      children: [
        (0, T.jsx)(`span`, { className: `text-gray-500 text-[10px] uppercase font-bold tracking-widest`, children: e }),
        (0, T.jsx)(`span`, {
          className: `text-sm ${n ? `font-mono text-gray-300` : r ? `text-[#ffb3ac] font-bold` : `text-white`} text-left sm:text-right font-medium`,
          children: t,
        }),
      ],
    }),
...
function ve() {
  let e =
    ...
    [b, x] = (0, _.useState)(!1),
    [ee, S] = (0, _.useState)(!1),
    [C, te] = (0, _.useState)(null),
    [ne, re] = (0, _.useState)(!1),
    [w, ue] = (0, _.useState)(!1),
    ve = (() => {
      if (!p.data_nascimento) return !1;
      let e = p.data_nascimento.split(`-`);
      if (e.length !== 3) return !1;
      let t = new Date(Number(e[0]), Number(e[1]) - 1, Number(e[2])),
        n = new Date(),
        r = n.getFullYear() - t.getFullYear(),
        i = n.getMonth() - t.getMonth();
      return ((i < 0 || (i === 0 && n.getDate() < t.getDate())) && r--, r < 18);
    })();
  ((0, _.useEffect)(() => {
    async function t() {
      try {
        let [t, r] = await Promise.all([
            fetch(`${de}/projetos-get?instituto=${e.toUpperCase()}`),
            fetch(`${de}/locais-evento-get?instituto=${e.toUpperCase()}`),
          ]),
          a = await t.json(),
          o = await r.json(),
          s = Array.isArray(a)
            ? a.filter((e) => [`eventos`, `evento`].includes((e.aplicabilidade || ``).toLowerCase()))
            : [],
          c = (Array.isArray(o) ? o : o?.value || [])
            .filter((e) => e.ativo !== !1)
            .map((e) => {
              let t = [
              ...
              return { ...e, enderecoCompleto: t.join(` - `) || `Endereço não informado` };
            });
        (n(s), i(c));
      } catch (e) {
    ...
    (0, _.useEffect)(() => {
      if (p.cpf.length !== 14) return;
      let e = p.cpf.replace(/\D/g, ``);
      (g(!0), y(!1), x(!1), S(!1));
      let t = window.location.pathname.split(`/`)[1]?.toUpperCase() || ``;
      Promise.all([
        fetch(`${de}/matriculas-get?instituto=${t}&cpf=${e}`)
          .then((e) => e.json())
          .catch(() => null),
        fetch(`${de}/matriculas-eventos-get?instituto=${t}&cpf=${e}`)
          .then((e) => e.json())
          .catch(() => null),
        fetch(`${de}/consultar-cpf?cpf=${e}`)
          .then((e) => e.json())
          .catch(() => null),
      ])
        .then(([t, n, r]) => {
          let _a = Array.isArray(n) ? n : n?.value || []; let i = _a.find((e) => l?.id ? String(e.projeto_id) === String(l?.id) : true) || _a[0];
          if (i) {
            (m((e) => ({
              ...e,
              nome: i.aluno_nome || i.nome || e.nome,
              data_nascimento: i.data_nascimento || i.nascimento || e.data_nascimento,
              whatsapp: i.whatsapp || i.telefone_conta || e.whatsapp,
              email: i.email || i.email_conta || e.email,
              tamanho_camisa: i.tamanho_camisa || e.tamanho_camisa,
            })),
              te(i),
              g(!1));
            return;
          }
          let a = Array.isArray(t) ? t : t?.value || [],
            o = a.find((t) => String(t.aluno_cpf).replace(/\D/g, ``) === e) || (a.length === 1 ? a[0] : null);
          if (o)
            (y(!0),
              m((e) => ({
                ...e,
                nome: o.aluno_nome || o.nome || ``,
                data_nascimento: o.data_nascimento || o.nascimento || ``,
                sexo: o.sexo || o.genero || ``,
                altura: o.altura ? String(o.altura) : ``,
                peso: o.peso ? String(o.peso) : ``,
                ...
                bairro: o.bairro || ``,
                cidade: o.cidade || o.localidade || ``,
                uf: o.uf || ``,
                faixa_salarial: o.faixa_salarial || o.renda || ``,
                whatsapp: o.whatsapp || o.telefone || o.celular || ``,
                profissao: o.profissao || ``,
                email: o.email || o.email_conta || ``,
                instagram: o.instagram || ``,
                resp_cpf: o.resp_cpf || ``,
                resp_nome: o.resp_nome || ``,
                grau_parentesco: o.grau_parentesco || ``,
                resp_data_nasc: o.resp_data_nasc || ``,
                resp_sexo: o.resp_sexo || ``,
                resp_email: o.resp_email || ``,
                resp_whatsapp: o.resp_whatsapp || ``,
                uso_medicacao: { value: o.uso_medicacao || `Nao`, detalhe: o.uso_medicacao_detalhes || `` },
                possui_alergias: { value: o.possui_alergias || `Nao`, detalhe: o.possui_alergias_detalhes || `` },
                plano_saude: { value: o.plano_saude || `Nao`, detalhe: o.plano_saude_detalhes || `` },
                acompan_medico: { value: o.acompan_medico || `Nao`, detalhe: o.acompan_medico_detalhes || `` },
                restricao_fisica: { value: o.restricao_fisica || `Nao`, detalhe: o.restricao_fisica_detalhes || `` },
                necessidade_especial: {
                  value: o.necessidade_especial || `Nao`,
                  detalhe: o.necessidade_especial_detalhes || ``,
                },
                deseja_laudo: o.deseja_laudo || `Nao`,
              })));
          else {
            y(!1);
            ...
            if (e?.status === !0 && e?.result) {
              x(!0);
              let t = e.result.nome_da_pf || ``,
                n = (e.result.data_nascimento || ``).split(`/`),
                r = n.length === 3 ? `${n[2]}-${n[1]}-${n[0]}` : ``;
              m((e) => ({ ...e, nome: t, data_nascimento: r }));
            } else x(!1);
          }
        })
        .finally(() => {
  ...
  let ye = async (e) => {
    let t = e.replace(/\D/g, ``),
      n = t;
    if ((t.length > 5 && (n = t.substring(0, 5) + `-` + t.substring(5, 8)), A(`cep`, n), t.length === 8))
      try {
        let e = await (await fetch(`https://w.ibrase.com.br/webhook/consultar-cep?cep=${t}`)).json();
        if (e && !e.erro) {
          let t = Array.isArray(e) ? e[0] : e.value && Array.isArray(e.value) ? e.value[0] : e,
            n = t?.result || t || {};
          (n.logradouro || n.endereco || n.bairro) &&
            m((e) => ({
              ...e,
              endereco: n.logradouro || n.endereco || e.endereco,
              bairro: n.bairro || e.bairro,
              cidade: n.localidade || n.cidade || e.cidade,
              uf: n.uf || e.uf,
            }));
        }
      } catch (e) {
  ...
  let A = (e, t) => m((n) => ({ ...n, [e]: t })),
    be = (e, t, n) => m((r) => ({ ...r, [e]: { ...r[e], [t]: n } })),
    xe = (t) => {
      t.preventDefault();
      let n = new FormData();
      (n.append(`intent`, `inscrever`),
        n.append(`projeto_id`, l?.id || ``),
        ...
        [
          ...
          let t = p[e];
          (n.append(e, t.value), n.append(`${e}_detalhes`, t.detalhe));
        }));
      let r = { instituto: e.toUpperCase() };
      (n.forEach((e, t) => (r[t] = e)),
        ue(!0),
        fetch(`${de}/matriculas-eventos-post`, {
          method: `POST`,
  ...
  if (a?.success || C) {
    let t = a?.result || C,
      n = t?.protocolo || t?.id || Math.random().toString(36).slice(2, 10).toUpperCase(),
      r = new Date().toLocaleDateString(`pt-BR`, { day: `2-digit`, month: `long`, year: `numeric` });
    return (0, T.jsxs)(`div`, {
      className: `min-h-screen bg-[#0F0F0F] text-white flex flex-col relative overflow-hidden print:bg-white print:text-black`,
      children: [
        (0, T.jsx)(`div`, { className: `print:hidden`, children: (0, T.jsx)(D, {}) }),
        (0, T.jsxs)(`main`, {
          className: `flex-grow flex flex-col items-center justify-center p-4 z-10 w-full max-w-lg mx-auto print:hidden`,
          children: [
            (0, T.jsx)(`div`, {
              className: `w-16 h-16 rounded-full bg-[#d32f2f]/20 flex items-center justify-center mb-6 border border-[#d32f2f]/50 shadow-[0_0_30px_#d32f2f] step-anim`,
              children: (0, T.jsx)(ae, { className: `text-[#ffb3ac] w-9 h-9` }),
            }),
            (0, T.jsx)(`h2`, {
              className: `text-2xl font-bold text-white mb-1 tracking-tight text-center step-anim`,
              children: `Inscrição Confirmada!`,
            }),
            (0, T.jsx)(`p`, {
              className: `text-gray-400 text-sm mb-8 text-center step-anim`,
              children: `Guarde sua ficha de inscrição abaixo.`,
            }),
            (0, T.jsxs)(`div`, {
              className: `w-full step-anim`,
              style: { animation: `fadeIn 0.6s 0.2s both` },
              children: [
                (0, T.jsxs)(`div`, {
                  className: `rounded-t-2xl bg-gradient-to-r from-[#d32f2f] to-[#8b0000] p-5 flex items-center justify-between`,
                  children: [
                    (0, T.jsxs)(`div`, {
                      ...
                      children: [
                        ...
                        (0, T.jsxs)(`div`, {
                          children: [
                            (0, T.jsx)(`p`, {
                              className: `text-white/70 text-[10px] uppercase tracking-widest font-bold`,
                              children: `Ficha de Inscrição`,
                            }),
                            (0, T.jsx)(`p`, {
                              className: `text-white font-bold text-sm leading-tight`,
                              children: l?.nome || `Evento`,
                            }),
                          ],
                        }),
                      ],
                    }),
                    (0, T.jsx)(ce, { className: `w-8 h-8 text-white/30` }),
                  ],
                }),
                (0, T.jsxs)(`div`, {
                  className: `glass-layer-1 rounded-b-2xl border-t-0 divide-y divide-white/5`,
                  children: [
                    (0, T.jsxs)(`div`, {
                      className: `p-5 text-center bg-white/[0.02]`,
                      children: [
                        (0, T.jsx)(`p`, {
                          className: `text-gray-400 text-[10px] uppercase tracking-widest font-bold mb-1`,
                          children: `Nº de Protocolo`,
                        }),
                        (0, T.jsx)(`p`, {
                    ...
                    (0, T.jsxs)(`div`, {
                      ...
                      children: [
                        (0, T.jsx)(ge, { label: `Nome`, value: t?.nome || p.nome || `—` }),
                        (0, T.jsx)(ge, { label: `CPF`, value: t?.cpf || p.cpf || `—`, mono: !0 }),
                        (t?.data_nascimento || p.data_nascimento) &&
                          (0, T.jsx)(ge, {
                            label: `Data de Nascimento`,
                            value: new Date((t?.data_nascimento || p.data_nascimento) + `T12:00:00`).toLocaleDateString(
                              `pt-BR`,
                            ),
                          }),
                        (t?.whatsapp || p.whatsapp) &&
                          (0, T.jsx)(ge, { label: `WhatsApp`, value: t?.whatsapp || p.whatsapp }),
                        (t?.email || p.email) && (0, T.jsx)(ge, { label: `E-mail`, value: t?.email || p.email }),
                      ],
                    }),
                    (0, T.jsxs)(`div`, {
                      className: `p-5 grid grid-cols-1 gap-4`,
                    ...
                    (0, T.jsxs)(`div`, {
                      className: `p-4 bg-white/[0.02] flex items-center justify-between`,
                      children: [
                        (0, T.jsxs)(`div`, {
                          children: [
                            (0, T.jsx)(`p`, { className: `text-gray-500 text-[10px]`, children: `Data de inscrição` }),
                            (0, T.jsx)(`p`, { className: `text-gray-300 text-xs font-semibold`, children: r }),
                          ],
                        }),
                        (0, T.jsxs)(`div`, {
                          className: `flex items-center gap-1.5 text-emerald-400 text-xs font-semibold`,
                          children: [
                            (0, T.jsx)(oe, { className: `w-4 h-4` }),
                            (0, T.jsx)(`span`, { children: `Vaga Garantida` }),
                          ],
                        }),
                      ],
                    }),
  ...
  dangerouslySetInnerHTML: {
    __html: `<div style="display:flex;align-items:center;gap:10px;background:#f8fafc;border:1px solid #cbd5e1;padding:6px 8px;margin-bottom:10px;border-radius:6px;">
      ...
      <div style="background:#f8fafc;border:1px solid #cbd5e1;padding:10px;border-radius:6px;margin-top:6px;">
        <div style="font-weight:bold;font-size:10pt;color:#0f172a;margin-bottom:15px;text-align:center;">TERMO DE RESPONSABILIDADE E ASSINATURAS</div>
        <div style="font-size:8pt;color:#334155;margin-bottom:20px;text-align:justify;">
          Declaro para os devidos fins que as informações prestadas são verdadeiras e me comprometo a seguir os Termos de Uso e Política de Privacidade da instituição.
        </div>
        <div style="display:flex;justify-content:space-between;margin-top:40px;gap:20px;">
          <div style="flex:1;text-align:center;">
            <div style="border-top:1px solid #000;margin-bottom:5px;"></div>
            <div style="font-size:9pt;font-weight:bold;">Assinatura do Aluno</div>
          </div>
          <div style="flex:1;text-align:center;">
            <div style="border-top:1px solid #000;margin-bottom:5px;"></div>
...
(0, T.jsxs)('div', {
  className: 'mt-6 flex flex-col sm:flex-row gap-3',
                  children: [
                    (0, T.jsx)(`button`, {
                      ...
                      className: `flex-1 btn-red text-white py-3.5 px-6 rounded-xl font-bold text-xs uppercase tracking-widest flex items-center justify-center gap-2`,
                      children: `🖨️ Imprimir / Salvar PDF`,
                    }),
                    (0, T.jsx)(`button`, {
                      onClick: () => {
                        (c(0), u(null), f(null), o(null), te(null), m(_e));
                      },
                      className: `glass-layer-1 hover:bg-white/10 text-gray-300 py-3.5 px-6 rounded-xl font-bold text-xs uppercase tracking-widest transition-colors`,
                      children: `Nova Inscrição`,
                    }),
                  ],
                }),
              ],
        ...
        (0, T.jsx)(`div`, {
          className: `hidden print:block text-black bg-white p-8 max-w-[210mm] mx-auto text-xs font-sans`,
          children: (0, T.jsxs)(`div`, {
            className: `border-2 border-slate-900 rounded-lg p-6 space-y-4`,
            children: [
              (0, T.jsxs)(`div`, {
                ...
                children: [
                  (0, T.jsxs)(`div`, {
                    ...
                    children: [
                      (0, T.jsx)(`img`, { src: me(e || ``), alt: e, className: `h-14 w-auto object-contain` }),
                      (0, T.jsxs)(`div`, {
                        children: [
                          (0, T.jsx)(`h1`, {
                            className: `text-lg font-black tracking-tight text-slate-900 uppercase`,
                            children: `Comprovante de Inscrição em Evento`,
                          }),
                          (0, T.jsx)(`p`, {
                            className: `text-slate-600 text-xs font-medium`,
                            children: `Plataforma INTEGRA — Sistema de Gestão Unificada`,
                          }),
                        ],
                      }),
                    ],
                  ...
                  (0, T.jsxs)(`div`, {
                    ...
                    children: [
                      (0, T.jsx)(`p`, {
                        ...
                        children: `Protocolo Oficial`,
                      }),
                      (0, T.jsx)(`p`, {
                        className: `text-lg font-black font-mono tracking-widest text-slate-900`,
                        children: n,
                      }),
                    ],
                  }),
              ...
              (0, T.jsxs)(`div`, {
                className: `bg-slate-100 border border-slate-300 rounded p-3 text-center`,
                children: [
                  (0, T.jsx)(`span`, {
                    className: `text-[10px] uppercase font-bold text-slate-500 tracking-widest block`,
                    children: `Evento`,
                  }),
                  (0, T.jsx)(`span`, { className: `text-base font-black text-slate-900`, children: l?.nome }),
                ],
              }),
              (0, T.jsxs)(`div`, {
                ...
                children: [
                  (0, T.jsxs)(`div`, {
                    className: `border border-slate-300 rounded p-3 space-y-2`,
                    children: [
                      (0, T.jsx)(`h2`, {
                        className: `text-[11px] font-black uppercase text-slate-900 border-b border-slate-200 pb-1`,
                        children: `Dados do Participante`,
                      }),
                      (0, T.jsxs)(`div`, {
                        children: [
                          (0, T.jsx)(`span`, { className: `text-slate-500 font-bold`, children: `Nome:` }),
                          ` `,
                          (0, T.jsx)(`span`, {
                            className: `font-semibold text-slate-900`,
                            children: t?.nome || p.nome,
                          }),
                        ],
                      }),
                      (0, T.jsxs)(`div`, {
                        children: [
                          (0, T.jsx)(`span`, { className: `text-slate-500 font-bold`, children: `CPF:` }),
                          ` `,
                          (0, T.jsx)(`span`, { className: `font-mono text-slate-900`, children: t?.cpf || p.cpf }),
                        ],
                      }),
                      (t?.data_nascimento || p.data_nascimento) &&
                        (0, T.jsxs)(`div`, {
                          children: [
                            (0, T.jsx)(`span`, { className: `text-slate-500 font-bold`, children: `Nascimento:` }),
                            ` `,
                            (0, T.jsx)(`span`, {
                              className: `text-slate-900`,
                              children: new Date(
                                (t?.data_nascimento || p.data_nascimento) + `T12:00:00`,
                      ...
                      (t?.whatsapp || p.whatsapp) &&
                        (0, T.jsxs)(`div`, {
                          children: [
                            (0, T.jsx)(`span`, { className: `text-slate-500 font-bold`, children: `WhatsApp:` }),
                            ` `,
                            (0, T.jsx)(`span`, { className: `text-slate-900`, children: t?.whatsapp || p.whatsapp }),
                          ],
                        }),
                      (t?.email || p.email) &&
                        (0, T.jsxs)(`div`, {
                          children: [
                            (0, T.jsx)(`span`, { className: `text-slate-500 font-bold`, children: `E-mail:` }),
                            ` `,
                            (0, T.jsx)(`span`, { className: `text-slate-900`, children: t?.email || p.email }),
                          ],
                        }),
                      (t?.tamanho_camisa || p.tamanho_camisa) &&
                        (0, T.jsxs)(`div`, {
                          children: [
                            (0, T.jsx)(`span`, { className: `text-slate-500 font-bold`, children: `Camisa:` }),
                            ` `,
                            (0, T.jsx)(`span`, {
                              className: `font-bold text-slate-900`,
                              children: t?.tamanho_camisa || p.tamanho_camisa,
                            }),
                          ],
                        }),
                    ],
                  ...
                  (0, T.jsxs)(`div`, {
                    ...
                    children: [
                      (0, T.jsx)(`h2`, {
                        className: `text-[11px] font-black uppercase text-slate-900 border-b border-slate-200 pb-1`,
                        children: `Informações do Local`,
                      }),
                      (0, T.jsxs)(`div`, {
                        children: [
                          (0, T.jsx)(`span`, { className: `text-slate-500 font-bold`, children: `Núcleo/Local:` }),
                          ` `,
                          (0, T.jsx)(`span`, { className: `font-bold text-slate-900`, children: d?.nome }),
                        ],
                      }),
                      (0, T.jsxs)(`div`, {
                        children: [
                          (0, T.jsx)(`span`, { className: `text-slate-500 font-bold`, children: `Endereço:` }),
                          ` `,
                          (0, T.jsx)(`span`, { className: `text-slate-900`, children: d?.enderecoCompleto }),
                        ],
                      }),
                      (0, T.jsxs)(`div`, {
                        children: [
                          (0, T.jsx)(`span`, { className: `text-slate-500 font-bold`, children: `Status:` }),
                          ` `,
                          (0, T.jsx)(`span`, { className: `font-bold text-emerald-700`, children: `Inscrição Válida` }),
                        ],
                      }),
                      (0, T.jsxs)(`div`, {
                        children: [
                          (0, T.jsx)(`span`, { className: `text-slate-500 font-bold`, children: `Emissão:` }),
                          ` `,
                          (0, T.jsx)(`span`, { className: `text-slate-900`, children: r }),
                        ],
                      }),
                    ],
                  }),
              ...
              (0, T.jsxs)(`div`, {
                className: `border-t-2 border-slate-900 pt-4 mt-6 grid grid-cols-2 gap-8`,
                children: [
                  (0, T.jsxs)(`div`, {
                    className: `border-t-[1.5px] border-slate-700 pt-1 text-center`,
                    children: [
                      (0, T.jsx)(`p`, {
                        className: `font-extrabold text-xs text-slate-900 uppercase`,
                        children: `Assinatura do Participante / Responsável`,
                      }),
                      (0, T.jsx)(`p`, { className: `text-[10px] text-slate-800 mt-0.5`, children: t?.nome || p.nome }),
                    ],
                  }),
                  (0, T.jsxs)(`div`, {
                    className: `border-t-[1.5px] border-slate-700 pt-1 text-center`,
                    children: [
                      (0, T.jsx)(`p`, {
                        className: `font-extrabold text-xs text-slate-900 uppercase`,
                        children: `Coordenação do Evento`,
                      }),
                      (0, T.jsx)(`p`, { className: `text-[10px] text-slate-800 mt-0.5`, children: `Visto / Carimbo` }),
                    ],
                  }),
                ],
              }),
  ...
  let Se = ({ active: e }) =>
      (0, T.jsx)(`div`, {
        className: `w-2.5 h-2.5 rounded-full transition-all duration-500 ${e ? `bg-[#d32f2f] shadow-[0_0_12px_#d32f2f]` : `bg-white/20`}`,
      }),
    Ce = () => (0, T.jsx)(`div`, { className: `h-[2px] w-8 md:w-10 bg-white/10 rounded` });
  return (0, T.jsxs)(`div`, {
    className: `min-h-screen bg-[#0F0F0F] text-white font-sans flex flex-col justify-between relative overflow-x-hidden`,
    children: [
      (0, T.jsx)(D, {}),
      (0, T.jsxs)(`main`, {
        className: `flex-grow flex flex-col items-center justify-center py-8 md:py-14 px-4 w-full max-w-xl mx-auto z-10`,
        children: [
          s === 0 &&
            (0, T.jsxs)(`div`, {
              className: `w-full flex flex-col items-center step-anim`,
              children: [
                (0, T.jsxs)(`div`, {
                  ...
                  children: [
                    (0, T.jsx)(`img`, {
                      src: me(e || ``),
                      alt: e,
                      className: `h-16 md:h-20 max-w-[240px] w-auto object-contain mb-3 drop-shadow-[0_4px_12px_rgba(0,0,0,0.5)] transition-transform hover:scale-105 duration-300`,
                      onError: (e) => {
                        e.target.style.display = `none`;
                      },
                    }),
                    (0, T.jsx)(`h1`, {
                      className: `text-2xl md:text-3xl font-extrabold text-white tracking-tight leading-tight mb-2`,
                      children: `Faça sua matrícula`,
                    }),
                    (0, T.jsx)(`p`, {
                      className: `text-gray-400 text-xs md:text-sm font-normal max-w-sm mx-auto`,
                      children: `Selecione um dos eventos abaixo para iniciar sua inscrição`,
                    }),
                  ],
                }),
                (0, T.jsxs)(`div`, {
                  className: `w-full max-w-xs mb-6 flex items-center justify-center space-x-2`,
                  children: [
                    (0, T.jsx)(Se, { active: s >= 0 }),
                    (0, T.jsx)(Ce, {}),
                    (0, T.jsx)(Se, { active: s >= 1 }),
                    (0, T.jsx)(Ce, {}),
                    (0, T.jsx)(Se, { active: s >= 2 }),
                    (0, T.jsx)(Ce, {}),
                    (0, T.jsx)(Se, { active: s >= 3 }),
                  ],
                }),
                (0, T.jsx)(`div`, {
                  ...
                  children:
                    (!t) ? (0, T.jsxs)('div', { className: 'glass-layer-1 rounded-2xl p-10 text-center border border-white/10', children: [(0, T.jsx)('h3', { className: 'text-lg font-bold text-white mb-1 animate-pulse', children: 'Buscando Eventos...' }), (0, T.jsx)('p', { className: 'text-gray-400 text-sm', children: 'Aguarde um instante' })] }) : t.length === 0
                      ? (0, T.jsxs)(`div`, {
                          ...
                          children: [
                            (0, T.jsx)(ce, { className: `w-14 h-14 mx-auto mb-3 text-white/20` }),
                            (0, T.jsx)(`h3`, {
                            ...
                            (0, T.jsx)(`p`, {
                              ...
                              children: `Nenhum evento com inscrições abertas no momento.`,
                            }),
                          ],
                        })
                      : t.map((e, t) =>
                          (0, T.jsxs)(
                            `div`,
                            {
                              ...
                              className: `glass-layer-1 rounded-2xl p-5 md:p-6 cursor-pointer group glow-active flex items-center justify-between border border-white/10 hover:border-[#d32f2f]/60 hover:bg-white/[0.07] transition-all duration-300 shadow-lg`,
                              children: [
                                (0, T.jsxs)(`div`, {
                                  className: `pr-3`,
                                  children: [
                                    (0, T.jsxs)(`div`, {
                                      ...
                                      children: [
                                        (0, T.jsx)(`span`, {
                                          className: `inline-block w-2 h-2 rounded-full bg-[#d32f2f] animate-pulse`,
                                        }),
                                        (0, T.jsx)(`span`, {
                                          className: `text-[10px] font-bold uppercase tracking-wider text-[#ffb3ac]`,
                                          children: `Inscrições Abertas`,
                                        }),
                                      ],
                                    }),
                                    (0, T.jsx)(`h2`, {
                                      className: `text-lg md:text-xl font-bold text-white group-hover:text-[#ffb3ac] transition-colors leading-snug mb-1`,
                                      children: e.nome,
                                    }),
                                    (0, T.jsx)(`p`, {
                                ...
                                (0, T.jsx)(`div`, {
                                  className: `w-10 h-10 rounded-full bg-white/5 group-hover:bg-[#d32f2f]/20 flex items-center justify-center flex-shrink-0 transition-colors border border-white/5 group-hover:border-[#d32f2f]/40`,
                                  children: (0, T.jsx)(ie, {
                                    className: `w-5 h-5 text-gray-400 group-hover:text-[#ffb3ac] transition-colors`,
                                  }),
                                }),
                              ],
                            },
                  ...
                  children: [
                    ...
                    r.length === 0
                      ? (0, T.jsxs)(`div`, {
                          className: `glass-layer-1 rounded-2xl p-10 text-center border border-white/10`,
                          children: [
                            (0, T.jsx)(se, { className: `w-16 h-16 mx-auto mb-4 text-white/20` }),
                            (0, T.jsx)(`p`, { className: `text-gray-400`, children: `Nenhum local cadastrado.` }),
                          ],
                        })
                      : r.map((e, t) =>
                          (0, T.jsxs)(
                            `div`,
                            {
                              ...
                              className: `glass-layer-1 rounded-2xl p-5 cursor-pointer group glow-active border border-white/10 hover:border-[#d32f2f]/60 hover:bg-white/[0.07] transition-all duration-300`,
                              children: [
                                (0, T.jsx)(`h2`, {
                                  className: `text-base md:text-lg font-bold text-white group-hover:text-[#ffb3ac] transition-colors mb-1`,
                                  children: e.nome,
                                }),
                                e.enderecoCompleto &&
                                  (0, T.jsxs)(`div`, {
                    ...
                    (0, T.jsx)(`button`, {
                      onClick: () => c(0),
                      className: `mt-4 text-gray-500 hover:text-white transition-colors text-xs uppercase tracking-widest font-bold block mx-auto`,
                      children: `← Voltar`,
                    }),
                  ],
                }),
          ...
          s === 2 &&
            (0, T.jsxs)(`div`, {
              ...
              children: [
                ...
                (0, T.jsxs)(`div`, {
                  className: `w-full glass-layer-2 rounded-3xl p-6 md:p-8 flex flex-col items-center text-center border border-white/15 shadow-2xl`,
                  children: [
                    (0, T.jsx)(`div`, {
                      className: `w-14 h-14 rounded-full bg-[#d32f2f]/10 flex items-center justify-center mb-5 border border-[#d32f2f]/30`,
                      children: (0, T.jsx)(le, { className: `text-[#ffb3ac] w-7 h-7` }),
                    }),
                    (0, T.jsx)(`h2`, { className: `text-2xl font-bold text-white mb-2`, children: `Identificação` }),
                    (0, T.jsx)(`p`, {
                      className: `text-gray-400 mb-6 text-sm`,
                      children: `Informe seu CPF para continuar.`,
                    }),
                    (0, T.jsx)(`div`, {
                      ...
                      children: (0, T.jsx)(`input`, {
                        ...
                        value: p.cpf,
                        onChange: (e) => {
                          (A(`cpf`, fe(e.target.value)), y(!1), S(!1));
                        },
                      }),
                    }),
                    h &&
                      (0, T.jsx)(`p`, {
                        className: `text-yellow-400 text-xs mb-4 animate-pulse`,
                        children: `🔍 Verificando cadastro...`,
                      }),
                    !h &&
                      ee &&
                      (0, T.jsxs)(`div`, {
                        className: `glass-layer-1 rounded-xl p-4 mb-4 border border-red-500/40 text-center`,
                        children: [
                          (0, T.jsx)(`p`, {
                            className: `text-red-400 font-bold text-sm mb-1`,
                            children: `⚠️ Inscrição já realizada`,
                          }),
                          (0, T.jsxs)(`p`, {
                            className: `text-gray-400 text-xs`,
                            children: [
                              `Este CPF já está inscrito no evento `,
                              (0, T.jsx)(`strong`, { className: `text-white`, children: l?.nome }),
                              `.`,
                            ],
                          }),
                        ],
                    ...
                    (0, T.jsxs)(`button`, {
                      onClick: () => {
                        p.cpf.length === 14 && !h && !ee && c(3);
                      },
                      disabled: p.cpf.length !== 14 || h || ee,
                      ...
                      children: [
                        h ? `Verificando...` : ee ? `Inscrição Bloqueada` : `Próximo`,
                        ` `,
                        !ee && (0, T.jsx)(ie, { className: `ml-2 w-5 h-5` }),
                      ],
                    }),
                    (0, T.jsx)(`button`, {
                      onClick: () => c(1),
                      className: `mt-5 text-gray-500 hover:text-white transition-colors text-xs uppercase tracking-widest font-bold`,
                      children: `← Voltar`,
                    }),
                  ],
                }),
          ...
          s === 3 &&
            (0, T.jsxs)(`div`, {
              ...
              children: [
                ...
                (0, T.jsx)(`div`, {
                  className: `w-full glass-layer-2 rounded-3xl p-6 md:p-8 border border-white/15 shadow-2xl`,
                  children: v
                    ? (0, T.jsxs)(T.Fragment, {
                        children: [
                          (0, T.jsx)(`h2`, {
                            className: `text-xl font-bold text-white mb-6 text-center`,
                            children: `Confirmar Inscrição`,
                          }),
                          (0, T.jsxs)(`form`, {
                            className: `space-y-5`,
                            onSubmit: xe,
                            children: [
                              (0, T.jsxs)(`div`, {
                                children: [
                                  (0, T.jsx)(O, { children: `CPF` }),
                                  (0, T.jsx)(k, { disabled: !0, value: p.cpf }),
                                ],
                              }),
                              (0, T.jsxs)(`div`, {
                                children: [
                                  (0, T.jsx)(O, { children: `Nome` }),
                                  (0, T.jsx)(k, { disabled: !0, value: p.nome }),
                                ],
                              }),
                              p.data_nascimento &&
                                (0, T.jsxs)(`div`, {
                                  children: [
                                    (0, T.jsx)(O, { children: `Data de Nascimento` }),
                                    (0, T.jsx)(k, { disabled: !0, value: p.data_nascimento }),
                                  ],
                                }),
                              (0, T.jsxs)(`div`, {
                                className: `pt-4 border-t border-white/10`,
                                children: [
                                  (0, T.jsx)(O, { children: `Tamanho da Camisa *` }),
                                  (0, T.jsxs)(he, {
                                    required: !0,
                                    value: p.tamanho_camisa,
                                    onChange: (e) => A(`tamanho_camisa`, e.target.value),
                                    children: [
                                      (0, T.jsx)(`option`, { value: ``, disabled: !0, children: `Selecione` }),
                                      (0, T.jsx)(`option`, {
                                        value: `10 anos - Infantil`,
                                        children: `10 anos - Infantil`,
                                      }),
                                      (0, T.jsx)(`option`, {
                                        value: `14 anos - Infantil`,
                                        children: `14 anos - Infantil`,
                                      }),
                                      (0, T.jsx)(`option`, { value: `M - Adulto`, children: `M - Adulto` }),
                                      (0, T.jsx)(`option`, { value: `GG - Adulto`, children: `GG - Adulto` }),
                                      (0, T.jsx)(`option`, { value: `G2 - Plus Adulto`, children: `G2 - Plus Adulto` }),
                                      (0, T.jsx)(`option`, { value: `G4 - Plus Adulto`, children: `G4 - Plus Adulto` }),
                                    ],
                                  }),
                                ],
                              }),
                              (0, T.jsx)(`div`, {
                                ...
                                children: (0, T.jsxs)(`button`, {
                                  type: `submit`,
                                  disabled: w,
                                  className: `w-full btn-red text-white py-4 rounded-xl font-bold text-sm uppercase tracking-widest pulse-submit flex justify-center items-center`,
                                  children: [
                                    w ? `Registrando...` : `Confirmar Inscrição`,
                                    (0, T.jsx)(oe, { className: `ml-2 w-5 h-5` }),
                                  ],
                                }),
                              }),
                              (0, T.jsx)(`button`, {
                                type: `button`,
                                onClick: () => c(2),
                                className: `w-full mt-2 text-center text-gray-500 hover:text-white transition-colors text-xs uppercase tracking-widest font-bold block`,
                                children: `← Voltar`,
                              }),
                            ],
                          }),
                    ...
                    : (0, T.jsxs)(T.Fragment, {
                        children: [
                          (0, T.jsx)(`h2`, {
                            className: `text-xl font-bold text-white mb-6 text-center`,
                            children: `Formulário de Inscrição`,
                          }),
                          (0, T.jsxs)(`form`, {
                            className: `space-y-5`,
                            onSubmit: xe,
                            children: [
                              ...
                              (0, T.jsxs)(`div`, {
                                children: [
                                  (0, T.jsx)(O, { children: `Nome Completo *` }),
                                  (0, T.jsx)(k, {
                                    required: !0,
                                    placeholder: `Nome completo`,
                                    value: p.nome,
                                    onChange: (e) => A(`nome`, e.target.value),
                              ...
                              (0, T.jsxs)(`div`, {
                                ...
                                children: [
                                  (0, T.jsxs)(`div`, {
                                    children: [
                                      ...
                                      (0, T.jsx)(k, {
                                        ...
                                        onChange: (e) => A(`data_nascimento`, e.target.value),
                                        disabled: b,
                                      }),
                                    ],
                                  }),
                                  (0, T.jsxs)(`div`, {
                                    children: [
                                      (0, T.jsx)(O, { children: `Gênero *` }),
                                      (0, T.jsxs)(he, {
                                        required: !0,
                                        value: p.sexo,
                                        onChange: (e) => A(`sexo`, e.target.value),
                                        children: [
                                          (0, T.jsx)(`option`, { value: ``, disabled: !0, children: `Selecione` }),
                                          (0, T.jsx)(`option`, { value: `M`, children: `Masculino` }),
                                          (0, T.jsx)(`option`, { value: `F`, children: `Feminino` }),
                                          (0, T.jsx)(`option`, { value: `Outro`, children: `Outro` }),
                                        ],
                                      }),
                                    ],
                                  }),
                              ...
                              (0, T.jsxs)(`div`, {
                                ...
                                children: [
                                  (0, T.jsxs)(`div`, {
                                    children: [
                                      (0, T.jsx)(O, { children: `Altura (cm)` }),
                                      (0, T.jsx)(k, {
                                        type: `number`,
                                        placeholder: `Ex: 175`,
                                        value: p.altura,
                                        onChange: (e) => A(`altura`, e.target.value),
                                      }),
                                    ],
                                  }),
                                  (0, T.jsxs)(`div`, {
                                    children: [
                                      (0, T.jsx)(O, { children: `Peso (kg)` }),
                                      (0, T.jsx)(k, {
                                        type: `number`,
                                        placeholder: `Ex: 70`,
                                        value: p.peso,
                                        onChange: (e) => A(`peso`, e.target.value),
                                      }),
                                    ],
                                  }),
                                ],
                              ...
                              (0, T.jsxs)(`div`, {
                                children: [
                                  (0, T.jsx)(O, { children: `Escolaridade *` }),
                                  (0, T.jsxs)(he, {
                                    required: !0,
                                    value: p.escolaridade,
                                    onChange: (e) => A(`escolaridade`, e.target.value),
                                    children: [
                                      (0, T.jsx)(`option`, { value: ``, disabled: !0, children: `Selecione` }),
                                      (0, T.jsx)(`option`, {
                                        value: `Fundamental Incompleto`,
                                        children: `Fundamental Incompleto`,
                                      }),
                                      (0, T.jsx)(`option`, {
                                        value: `Fundamental Completo`,
                                        children: `Fundamental Completo`,
                                      }),
                                      (0, T.jsx)(`option`, { value: `Médio Incompleto`, children: `Médio Incompleto` }),
                                      (0, T.jsx)(`option`, { value: `Médio Completo`, children: `Médio Completo` }),
                                      (0, T.jsx)(`option`, {
                                        value: `Superior Incompleto`,
                                        children: `Superior Incompleto`,
                                      }),
                                      (0, T.jsx)(`option`, {
                                        value: `Superior Completo`,
                                        children: `Superior Completo`,
                                      }),
                                      (0, T.jsx)(`option`, { value: `Pós-graduação`, children: `Pós-graduação` }),
                                    ],
                                  }),
                                ],
                              }),
                              (0, T.jsxs)(`div`, {
                                ...
                                children: [
                                  (0, T.jsxs)(`div`, {
                                    children: [
                                      (0, T.jsx)(O, { children: `Profissão` }),
                                      (0, T.jsxs)(he, {
                                        value: p.profissao,
                                        onChange: (e) => A(`profissao`, e.target.value),
                                        children: [
                                          (0, T.jsx)(`option`, { value: ``, children: `Selecione (opcional)` }),
                                          (0, T.jsx)(`option`, { value: `Estudante`, children: `Estudante` }),
                                          (0, T.jsx)(`option`, {
                                            value: `Empregado(a) com carteira`,
                                            children: `Empregado(a) com carteira`,
                                          }),
                                          (0, T.jsx)(`option`, {
                                            value: `Desempregado(a)`,
                                            children: `Desempregado(a)`,
                                          }),
                                          (0, T.jsx)(`option`, { value: `Autônomo(a)`, children: `Autônomo(a)` }),
                                          (0, T.jsx)(`option`, { value: `Aposentado(a)`, children: `Aposentado(a)` }),
                                          (0, T.jsx)(`option`, {
                                            value: `Dona(o) de Casa`,
                                            children: `Dona(o) de Casa`,
                                          }),
                                          (0, T.jsx)(`option`, { value: `Outro`, children: `Outro` }),
                                        ],
                                      }),
                                  ...
                                  (0, T.jsxs)(`div`, {
                                    children: [
                                      (0, T.jsx)(O, { children: `Faixa Salarial` }),
                                      (0, T.jsxs)(he, {
                                        value: p.faixa_salarial,
                                        onChange: (e) => A(`faixa_salarial`, e.target.value),
                                        children: [
                                          (0, T.jsx)(`option`, { value: ``, disabled: !0, children: `Selecione` }),
                                          (0, T.jsx)(`option`, { value: `Sem renda`, children: `Sem renda` }),
                                          (0, T.jsx)(`option`, {
                                            value: `Até 1 salário mínimo`,
                                            children: `Até 1 salário mínimo`,
                                          }),
                                          (0, T.jsx)(`option`, {
                                            value: `De 1 a 2 salários mínimos`,
                                            children: `De 1 a 2 salários mínimos`,
                                          }),
                                          (0, T.jsx)(`option`, {
                                            value: `De 2 a 3 salários mínimos`,
                                            children: `De 2 a 3 salários mínimos`,
                                          }),
                                          (0, T.jsx)(`option`, {
                                            value: `Acima de 3 salários mínimos`,
                                            children: `Acima de 3 salários mínimos`,
                                          }),
                                        ],
                                      }),
                                    ],
                              ...
                              (0, T.jsxs)(`div`, {
                                ...
                                children: [
                                  (0, T.jsx)(`p`, {
                                    className: `text-center text-gray-500 text-xs font-bold uppercase tracking-widest mb-4`,
                                    children: `Contato`,
                                  }),
                                  (0, T.jsxs)(`div`, {
                                    className: `space-y-4`,
                                    children: [
                                      (0, T.jsxs)(`div`, {
                                        children: [
                                          (0, T.jsx)(O, { children: `WhatsApp *` }),
                                          (0, T.jsx)(k, {
                                            required: !0,
                                            placeholder: `(00) 00000-0000`,
                                            value: p.whatsapp,
                                            onChange: (e) => A(`whatsapp`, pe(e.target.value)),
                                          }),
                                        ],
                                      }),
                                      (0, T.jsxs)(`div`, {
                                        children: [
                                          (0, T.jsx)(O, { children: `E-mail *` }),
                                          (0, T.jsx)(k, {
                                            required: !0,
                                            type: `email`,
                                          ...
                                          (0, T.jsxs)(`div`, {
                                            ...
                                            children: [
                                              ...
                                              (0, T.jsx)(k, {
                                                ...
                                                value: p.instagram,
                                                onChange: (e) => A(`instagram`, e.target.value),
                                                className: `pl-11`,
                                              }),
                                            ],
                                          }),
                                ...
                                children: [
                                  ...
                                  (0, T.jsxs)(`div`, {
                                    ...
                                    children: [
                                      ...
                                      (0, T.jsxs)(`div`, {
                                        children: [
                                          (0, T.jsx)(O, { children: `Rua / Logradouro *` }),
                                          (0, T.jsx)(k, {
                                            required: !0,
                                            placeholder: `Nome da rua`,
                                            value: p.endereco,
                                            onChange: (e) => A(`endereco`, e.target.value),
                                          }),
                                        ],
                                      }),
                                      (0, T.jsxs)(`div`, {
                                        ...
                                        children: [
                                          (0, T.jsxs)(`div`, {
                                            children: [
                                              (0, T.jsx)(O, { children: `Número *` }),
                                              (0, T.jsx)(k, {
                                                required: !0,
                                                placeholder: `Nº`,
                                                value: p.numero,
                                                onChange: (e) => A(`numero`, e.target.value),
                                              }),
                                            ],
                                          }),
                                          (0, T.jsxs)(`div`, {
                                            children: [
                                              (0, T.jsx)(O, { children: `Complemento` }),
                                              (0, T.jsx)(k, {
                                                placeholder: `Apto, Bloco...`,
                                                value: p.complemento,
                                                onChange: (e) => A(`complemento`, e.target.value),
                                              }),
                                            ],
                                          }),
                                        ],
                                      ...
                                      (0, T.jsxs)(`div`, {
                                        children: [
                                          (0, T.jsx)(O, { children: `Bairro *` }),
                                          (0, T.jsx)(k, {
                                            required: !0,
                                            placeholder: `Bairro`,
                                            value: p.bairro,
                                            onChange: (e) => A(`bairro`, e.target.value),
                                          }),
                                        ],
                                      }),
                                      (0, T.jsxs)(`div`, {
                                        ...
                                        children: [
                                          (0, T.jsxs)(`div`, {
                                            ...
                                            children: [
                                              (0, T.jsx)(O, { children: `Cidade *` }),
                                              (0, T.jsx)(k, {
                                                required: !0,
                                                placeholder: `Cidade`,
                                                value: p.cidade,
                                                onChange: (e) => A(`cidade`, e.target.value),
                                              }),
                                            ],
                                          }),
                                          (0, T.jsxs)(`div`, {
                                            children: [
                                              (0, T.jsx)(O, { children: `UF *` }),
                                              (0, T.jsx)(k, {
                                                required: !0,
                                                placeholder: `UF`,
                                                maxLength: 2,
                                                value: p.uf,
                                                onChange: (e) => A(`uf`, e.target.value.toUpperCase()),
                                                style: { textTransform: `uppercase` },
                                              }),
                                            ],
                                          }),
                              ...
                              ve &&
                                (0, T.jsxs)(`div`, {
                                  ...
                                  children: [
                                    (0, T.jsx)(`p`, {
                                      className: `text-center text-yellow-500/80 text-xs font-bold uppercase tracking-widest mb-4`,
                                      children: `Dados do Responsável Legal (Menor de 18)`,
                                    }),
                                    (0, T.jsxs)(`div`, {
                                      className: `space-y-4`,
                                      children: [
                                        (0, T.jsxs)(`div`, {
                                          children: [
                                            (0, T.jsx)(O, { children: `CPF do Responsável *` }),
                                            (0, T.jsx)(k, {
                                              required: !0,
                                              placeholder: `000.000.000-00`,
                                              maxLength: 14,
                                              value: p.resp_cpf,
                                              onChange: (e) => A(`resp_cpf`, fe(e.target.value)),
                                            }),
                                          ],
                                        }),
                                        (0, T.jsxs)(`div`, {
                                          children: [
                                            (0, T.jsx)(O, { children: `Nome do Responsável *` }),
                                            (0, T.jsx)(k, {
                                              required: !0,
                                              placeholder: `Nome completo`,
                                              value: p.resp_nome,
                                              onChange: (e) => A(`resp_nome`, e.target.value),
                                              style: { textTransform: `uppercase` },
                                            }),
                                          ],
                                        }),
                                        (0, T.jsxs)(`div`, {
                                          ...
                                          children: [
                                            (0, T.jsxs)(`div`, {
                                              children: [
                                                (0, T.jsx)(O, { children: `Grau de Parentesco *` }),
                                                (0, T.jsxs)(he, {
                                                  required: !0,
                                                  value: p.grau_parentesco,
                                                  onChange: (e) => A(`grau_parentesco`, e.target.value),
                                                  children: [
                                                    (0, T.jsx)(`option`, {
                                                      value: ``,
                                                      disabled: !0,
                                                    ...
                                                    (0, T.jsx)(`option`, { value: `Pai`, children: `Pai` }),
                                                    (0, T.jsx)(`option`, { value: `Mãe`, children: `Mãe` }),
                                                    (0, T.jsx)(`option`, { value: `Avô/Avó`, children: `Avô/Avó` }),
                                                    (0, T.jsx)(`option`, { value: `Tio/Tia`, children: `Tio/Tia` }),
                                                    (0, T.jsx)(`option`, {
                                                      value: `Tutor Legal`,
                                                      children: `Tutor Legal`,
                                                    }),
                                                    (0, T.jsx)(`option`, { value: `Outro`, children: `Outro` }),
                                                  ],
                                                }),
                                            ...
                                            (0, T.jsxs)(`div`, {
                                              children: [
                                                (0, T.jsx)(O, { children: `Data de Nasc. Resp.` }),
                                                (0, T.jsx)(k, {
                                                  type: `date`,
                                                  value: p.resp_data_nasc,
                                                  onChange: (e) => A(`resp_data_nasc`, e.target.value),
                                                }),
                                              ],
                                            }),
                                          ],
                                        ...
                                        (0, T.jsxs)(`div`, {
                                          ...
                                          children: [
                                            (0, T.jsxs)(`div`, {
                                              children: [
                                                (0, T.jsx)(O, { children: `Gênero Resp.` }),
                                                (0, T.jsxs)(he, {
                                                  value: p.resp_sexo,
                                                  onChange: (e) => A(`resp_sexo`, e.target.value),
                                                  children: [
                                                    (0, T.jsx)(`option`, {
                                                      value: ``,
                                                      disabled: !0,
                                            ...
                                            (0, T.jsxs)(`div`, {
                                              children: [
                                                (0, T.jsx)(O, { children: `WhatsApp Resp. *` }),
                                                (0, T.jsx)(k, {
                                                  required: !0,
                                                  placeholder: `(00) 00000-0000`,
                                                  value: p.resp_whatsapp,
                                                  onChange: (e) => A(`resp_whatsapp`, pe(e.target.value)),
                                                }),
                                              ],
                                            }),
                                          ],
                                        ...
                                        (0, T.jsxs)(`div`, {
                                          children: [
                                            (0, T.jsx)(O, { children: `E-mail Resp.` }),
                                            (0, T.jsx)(k, {
                                              type: `email`,
                                              placeholder: `email@responsavel.com`,
                                              value: p.resp_email,
                                              onChange: (e) => A(`resp_email`, e.target.value),
                                            }),
                                          ],
                                        }),
                                      ],
                              ...
                              (0, T.jsxs)(`div`, {
                                ...
                                children: [
                                  (0, T.jsx)(`p`, {
                                    className: `text-center text-gray-500 text-xs font-bold uppercase tracking-widest mb-4`,
                                    children: `Informações do Evento`,
                                  }),
                                  (0, T.jsxs)(`div`, {
                                    children: [
                                      (0, T.jsx)(O, { children: `Tamanho da Camisa *` }),
                                      (0, T.jsxs)(he, {
                                        ...
                                        children: [
                                          ...
                                          (0, T.jsx)(`option`, { value: `GG - Adulto`, children: `GG - Adulto` }),
                                          (0, T.jsx)(`option`, {
                                            value: `G2 - Plus Adulto`,
                                            children: `G2 - Plus Adulto`,
                                          }),
                                          (0, T.jsx)(`option`, {
                                            value: `G4 - Plus Adulto`,
                                            children: `G4 - Plus Adulto`,
                                          }),
                                        ],
                                      }),
                                    ],
                                    ...
                                    children: [
                                      [
                                        ...
                                        return (0, T.jsxs)(
                                          ...
                                          {
                                            children: [
                                              (0, T.jsxs)(O, { children: [t, ` *`] }),
                                              (0, T.jsxs)(`div`, {
                                                className: `radio-group flex space-x-6 mb-2`,
                                                children: [
                                                  (0, T.jsxs)(`label`, {
                                                    children: [
                                                      (0, T.jsx)(`input`, {
                                              ...
                                              n.value === `Sim` &&
                                                (0, T.jsx)(`input`, {
                                                  className: `custom-input w-full rounded-xl py-3 px-4 text-white text-sm`,
                                                  placeholder: `Especifique…`,
                                                  value: n.detalhe,
                                                  onChange: (t) => be(e, `detalhe`, t.target.value),
                                                }),
                                            ],
                                          },
                                          e,
                              ...
                              (0, T.jsx)(`div`, {
                                ...
                                children: (0, T.jsxs)(`label`, {
                                  ...
                                  children: [
                                    ...
                                    (0, T.jsxs)(`span`, {
                                      className: `text-gray-400 text-xs leading-relaxed group-hover:text-gray-300 transition-colors`,
                                      children: [
                                        `Li e aceito os `,
                                        (0, T.jsx)(`strong`, {
                                          className: `text-white`,
                                          children: `Termos de Uso e Política de Privacidade (LGPD)`,
                                        }),
                              ...
                              (0, T.jsx)(`div`, {
                                ...
                                children: (0, T.jsxs)(`button`, {
                                  ...
                                  className: `w-full btn-red text-white py-4 rounded-xl font-bold text-sm uppercase tracking-widest pulse-submit flex justify-center items-center`,
                                  children: [
                                    w ? `Registrando...` : `Finalizar Inscrição`,
                                    (0, T.jsx)(oe, { className: `ml-2 w-5 h-5` }),
                                  ],
                                }),
                              }),
      ...
      (0, T.jsxs)(`footer`, {
        className: `mt-auto py-6 w-full flex flex-col items-center justify-center opacity-60 hover:opacity-100 transition-opacity z-10`,
        children: [
          (0, T.jsx)(`span`, {
            className: `text-[9px] font-bold text-gray-400 mb-1 tracking-[0.3em] uppercase`,
            children: `Tecnologia`,
          }),
          (0, T.jsx)(`img`, {
            src: `/_prod_texto.png`,
            alt: `Integra`,
            className: `h-5 brightness-0 invert opacity-80 hover:opacity-100 transition-opacity drop-shadow-[0_0_8px_rgba(255,255,255,0.3)]`,
            onError: (e) => {
              e.target.style.display = `none`;
            },
          }),
...
(0, v.createRoot)(document.getElementById(`root`)).render((0, T.jsx)(_.StrictMode, { children: (0, T.jsx)(ve, {}) }));
